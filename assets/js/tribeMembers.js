export function displayTribeMembers(tribeMembers, tribeName) {
  const container = document.querySelector(".tribe-members");
  if (!container) return;
  ...
  tribeMembers.forEach((member, index) => {
    ...
    memberDiv.style.zIndex = tribeMembers.length - index;
